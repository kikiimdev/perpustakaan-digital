...
<head>
    <meta charset="utf-8">
    <title>Laporan Buku Terbanyak Dibaca</title>
    <style>
...
<body>
    <h1>Laporan Buku Terbanyak Dibaca</h1>
    ...
    <table>
        <thead>
            <tr>
                <th>Peringkat</th>
                <th>Judul</th>
                <th class="text-right">Total Halaman Dibaca</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->judul }}</td>
                <td class="text-right">{{ number_format($item->total_halaman) }}</td>
            </tr>
            @empty
            <tr><td colspan="3">Belum ada data membaca pada periode ini.</td></tr>
            @endforelse
        </tbody>
    </table>
